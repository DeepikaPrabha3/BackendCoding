...
/**
 * @Repository - Beacuse this is the repository of customer
 * The Moment spring calls AppConfig
 * => In AppConfig => we have said @Bean => so bean will be created and injected in customerDB*/
@Repository
